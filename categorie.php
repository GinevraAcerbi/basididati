...
<?php
$blogs = query_get("blog", [], ["id_cat_b" => $_GET["id_cat"]]);
?>
...
<body>
    <?php $categoria = query_get("categoria", ["descrcat"], ["id_cat" => $_GET["id_cat"]]); ?>
    <h1>Risultati trovati per ricerca per categoria:<?php echo strtoupper($categoria[0]["descrcat"]) ?> </h1>
<?php
foreach($blogs as $blog){
?>
  <div class="header">
    <h1><?php echo ($blog["titolob"]) ?></h1>
    <h3>
      <p><?php echo ($blog["descrizioneb"]) ?></p>
    </h3>
  </div>
  ...
  <div class="row">
    <div class="leftcolumn">
      <div class="card">
        <?php
        $post_correlati_id = query_get("post", ["id_post"], ["id_blog_p" => $blog["id_blog"]]);
        ...
        ?><h1><?php echo ($post_correlati[0]["titolop"]) ?></h1>
            <p>
            <h6>argomento: <?php echo ($post_correlati[0]["testop"]) ?></h6>
            </p>
            <p>
            <h6>data e ora di pubblicazione: <?php echo ($post_correlati[0]["data"]) . " " . ($post_correlati[0]["ora"]) ?></h6>
            </p>
            <p>
        ...
        <div class="rightcolumn">
          <div class="card">
            ...
            <p>
              <?php
              $username = query_get("utente", ["email"], ["id_utente" => $blog["id_utente_b"]]);
              echo ("Autore: " . $username[0]["email"]);
              ?>
            </p>
            <p>
              <?php
              $coautori_id = query_get("coautore", ["id_utente_fr"], ["id_blog_fr" => $blog["id_blog"]]);
            ...
            <p>
              <?php
              $categoria = query_get("categoria", ["descrcat"], ["id_cat" => $blog["id_cat_b"]]);
